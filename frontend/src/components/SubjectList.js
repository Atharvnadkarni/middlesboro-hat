...
const SubjectList = ({class:classe}) => {
  ...
  // const columns = {}
  const rows = [{ id: 1, roll_no: 1, name: "Mehr Kahlon", math: 97.5, english: 91.875, hindi: 100, science:100, ss: 91.8}];
  return <DataGrid columns={columns} rows={rows}>{console.log(columns, rows)}</DataGrid>;
};
